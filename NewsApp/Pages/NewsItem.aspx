...
<head runat="server">
    ...
    <link rel="Stylesheet" type="text/css" href="../Styles/news_item.css" />
    ...
    <script type="text/javascript" src="../Scripts/news_item.js"></script>
    <script type="text/javascript" src="../Scripts/news_item_resources.<SharePoint:EncodedLiteral runat='server' text='<% $Resources:wss,language_value %>' EncodeMethod='HtmlEncode' />.js"></script>
